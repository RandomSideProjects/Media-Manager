...
const TOODRIVE_PLAYER_RETIRED_HOST = 'td.alexspac.es';
...
function isToodrivePlayerHost(hostname, port) {
  ...
  if (host === TOODRIVE_PLAYER_PRIMARY_HOST || host === TOODRIVE_PLAYER_BACKUP_HOST || host === TOODRIVE_PLAYER_RETIRED_HOST) return true;
