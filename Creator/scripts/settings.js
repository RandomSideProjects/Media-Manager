...
function loadUploadSettings(){
  try {
    ...
    const result = {
      ...
      copypartyUrl: (typeof p.copypartyUrl === 'string') ? p.copypartyUrl.trim() : '',
      copypartyPw: (typeof p.copypartyPw === 'string') ? p.copypartyPw : '',
      copypartyPublicBase: (typeof p.copypartyPublicBase === 'string') ? p.copypartyPublicBase.trim() : '',
      copypartyDirectEnabled: (typeof p.copypartyDirectEnabled === 'boolean') ? p.copypartyDirectEnabled : false,
...
function saveUploadSettings(s){
  localStorage.setItem(LS_SETTINGS_KEY, JSON.stringify({
    ...
    copypartyUrl: (typeof s.copypartyUrl === 'string') ? s.copypartyUrl.trim() : '',
    copypartyPw: (typeof s.copypartyPw === 'string') ? s.copypartyPw : '',
    copypartyPublicBase: (typeof s.copypartyPublicBase === 'string') ? s.copypartyPublicBase.trim() : '',
    copypartyDirectEnabled: !!s.copypartyDirectEnabled,
